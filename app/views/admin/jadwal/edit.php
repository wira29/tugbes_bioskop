    ...
    <div class="d-flex max-w-100">
      ...
      <main class="p-4 flex-grow-1">
        <header class="container-fluid d-flex align-items-center gap-3">
          <a href="/admin/teater/<?= $data['id_teater'] ?>/jadwal" class="me-3 btn btn-warning"><span><i class="fa fa-arrow-left me-2"></i></span>Kembali</a>
        ...
        <article class="container-fluid ">
          <form class="needs-validation" novalidate action="/jadwal/<?= $data['id'] ?>/update" method="POST" enctype="multipart/form-data">
